...
function create() {
    ...
    // Create towers
    towers.push(this.add.sprite(200, 300, 'tower'));
    towers.push(this.add.sprite(400, 300, 'tower'));
...
function spawnEnemy() {
    let enemy = this.physics.add.sprite(50, 300, 'enemy');
    enemy.speed = 2;
    enemies.push(enemy);
}
...
function update() {
    ...
    towers.forEach(tower => {
        ...
        bullet.speed = 5;
        bullets.push(bullet);
        this.physics.moveTo(bullet, 800, bullet.y, bullet.speed);

        this.physics.add.collider(bullet, enemies, (bullet, enemy) => {
            enemy.destroy();
            bullet.destroy();
        });
    });
